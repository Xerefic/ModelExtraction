...
data_root_val = 'data/mit/videos/training'
ann_file_train = 'data/mit/videos/mit_train_list_videos.txt'
ann_file_val = 'data/mit/videos/mit_train_list_videos.txt'
ann_file_test = 'data/mit/videos/mit_train_list_videos.txt'
img_norm_cfg = dict(
